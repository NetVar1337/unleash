...
description: "Use when authoring in-repo SKILL.md (frontmatter, structure, writing-quality rules)."
version: 1.1.0
license: MIT
metadata:
  ...
  category: imported
  upstream: C:\Users\Admin\.agents\skills\hermes-agent-skill-authoring\SKILL.md
---

> Bundled with Unleash skills pack. Source: C:\Users\Admin\.agents\skills\hermes-agent-skill-authoring\SKILL.md
